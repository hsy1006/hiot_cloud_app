...
public class LineChartActivity extends BaseActivity<LineChartView, LineChartPresenter> implements LineChartView {
    ...
    @BindView(R.id.line_chart_histroy)
    LineChart lineChartHistroy;
    ...
    protected void onResume() {
        super.onResume();
        presenter.getUpDataStreamHistory(upDataStreamId);
    }
    ...
    public void showDataHistory(List<UpDataStreamSwitchBean> dataList) {
        ...
        lineChartHistroy.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            @Override
        ...
        MPChartHelper.setSingleLineChart(lineChartHistroy, xAxisValue, yAxisValue, timing,
